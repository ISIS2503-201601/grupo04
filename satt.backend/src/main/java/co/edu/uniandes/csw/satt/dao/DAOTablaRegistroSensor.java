 ...
 * @author Alejandro
 */
public class DAOTablaRegistroSensor {
	...
	public void setConn(Connection con){
        ...
        public void agregarRegistroSensor(RegistroSensor reg)throws SQLException, Exception
        {
            String sql = "INSERT INTO AS_REGISTRO_SENSOR (ID, ALTURA, VELOCIDAD, ID_SENSOR) VALUES (";
            sql += reg.getId() + ",";
            sql += reg.getAltura() + ",";
            sql += reg.getVelocidad() + ",";
            sql += reg.getIdSensor() + ")";
        ...
        public ArrayList<RegistroSensor> darRegistrosSensores() throws SQLException, Exception {
            ...
            while (rs.next()) {
                    ...
                    long altura = rs.getLong("ALTURA");
                    long velocidad = rs.getLong("VELOCIDAD");
                    long idSensor = rs.getLong("ID_SENSOR");
                    
                    reg.add(new RegistroSensor(id, altura, velocidad, idSensor));
            }
            return reg;
	}
